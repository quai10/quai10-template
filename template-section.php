...
<?php if (!empty(get_field('aside_content'))) { $grid = "grid-2-small-1"; } else {$grid = "grid";} ?>
  ...
  <div class="tpl_section-container <?php echo $grid ?> no-padding-left no-padding">
    ...
    <?php if (!empty(get_field('aside_content'))) : ?>
      <div class="tpl_section-aside" style="<?php if (!empty(get_field('aside_image'))) echo "background-image: url(" . get_field('aside_image')['url'] ." ) "; ?>">
